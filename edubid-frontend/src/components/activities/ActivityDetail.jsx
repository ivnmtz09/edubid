  ...
  if (!activity) {
    return (
      <div className="text-center py-8 sm:py-12 px-4">
        <p className="text-red-655 dark:text-red-400 text-base sm:text-lg mb-4 font-medium">Actividad no encontrada</p>
        <button 
          onClick={() => navigate("/activities")} 
          className="bg-purple-600 text-white px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg hover:bg-purple-700 transition font-medium text-sm sm:text-base active:scale-[0.96]"
        >
  ...
  return (
    <div className="space-y-4 sm:space-y-6 px-3 sm:px-4 lg:px-6 py-4 sm:py-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <button
          onClick={() => navigate("/activities")}
          className="flex items-center space-x-2 text-gray-500 dark:text-gray-400 mb-1 sm:mb-2 hover:text-gray-700 dark:hover:text-gray-200 transition-colors active:scale-[0.96]"
        >
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
          {isTeacher && (
            <button
              ...
              className="flex items-center justify-center gap-2 bg-purple-600 text-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl hover:bg-purple-700 transition text-sm sm:text-base active:scale-[0.96]"
            >
          ...
          {!isTeacher && canCancelSubmission && (
            <button
              ...
              className="flex items-center justify-center gap-2 bg-red-655 text-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl hover:bg-red-700 transition text-sm sm:text-base active:scale-[0.96]"
            >
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="bg-purple-600 p-4 sm:p-6 text-white">
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1 min-w-0">
              <span className="text-xs font-semibold uppercase bg-purple-50 dark:bg-purple-500/10 text-purple-700 dark:text-purple-300 px-2 py-1 rounded inline-block">
                {activity.tipo}
              </span>
              <h1 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold mt-2 break-words text-white">
                {activity.nombre}
              </h1>
            </div>
            {userSubmission && (
        ...
        {/* Body */}
        <div className="p-4 sm:p-5 lg:p-6 space-y-4 sm:space-y-5 lg:space-y-6 bg-white dark:bg-gray-900">
          {/* Descripción */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg mb-2">
              Descripción
            </h3>
            <p className="text-gray-600 dark:text-gray-400 whitespace-pre-wrap text-sm sm:text-base break-words">
          ...
          {activity.archivo_adjunto && (
            <div className="bg-purple-50 dark:bg-purple-500/10 border border-purple-200 dark:border-white/10 rounded-lg p-3 sm:p-4">
              <h3 className="font-semibold text-purple-700 dark:text-purple-300 text-sm sm:text-base mb-2 flex items-center gap-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-purple-700 dark:text-purple-350 hover:text-purple-800 dark:hover:text-purple-200 text-sm sm:text-base break-all active:scale-[0.96]"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-xl p-3 sm:p-4">
              <div className="flex items-center space-x-2 text-gray-600 dark:text-gray-400 mb-1 sm:mb-2">
                <CalendarIcon className="h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0" />
                <span className="text-xs sm:text-sm">Fecha de Entrega</span>
              </div>
              <p className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base break-words tabular-nums">
                {formatDate(activity.fecha_entrega)}
              </p>
              {activity.esta_vencida && (
                <span className="text-xs text-red-600 dark:text-red-400 mt-1 block">Vencida</span>
              )}
            </div>
              ...
              {isGraded ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className={`border rounded-xl p-4 sm:p-6 ${
                    ...
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* Calificación Grande */}
                        <div className="flex items-end gap-2 mb-4 tabular-nums">
                        ...
                        <div className="flex flex-wrap gap-3 sm:gap-4 text-xs sm:text-sm">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="tabular-nums">Calificado el {formatDate(userSubmission.actualizado || userSubmission.creado)}</span>
                          </div>
                  ...
                  {userSubmission.retroalimentacion && (
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-xl p-4 sm:p-6">
                      <div className="flex items-start gap-3 sm:gap-4">
                        <div className="flex-shrink-0 p-2 bg-purple-50 dark:bg-purple-500/10 rounded-lg">
                          <DocumentTextIcon className="h-5 w-5 sm:h-6 sm:w-6 text-purple-700 dark:text-purple-300" />
                        </div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3 sm:p-4">
                            <p className="text-sm sm:text-base text-purple-800 dark:text-purple-300 leading-relaxed whitespace-pre-wrap break-words">
                              {userSubmission.retroalimentacion}
                            </p>
                          </div>
                        </div>
                ...
                <div className="bg-purple-50 dark:bg-purple-500/10 border border-purple-200 dark:border-purple-500/20 rounded-xl p-4 sm:p-6">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <CheckCircleIcon className="h-6 w-6 sm:h-8 sm:w-8 text-purple-650 dark:text-purple-400 flex-shrink-0 mt-1" />
                    <div className="flex-1 min-w-0">
                      <h4 className="font-semibold text-purple-900 dark:text-purple-200 text-base sm:text-lg mb-2">
                        Entrega Pendiente de Calificación
                      </h4>
                      <p className="text-sm sm:text-base text-purple-700 dark:text-purple-300 mb-3">
                        Tu docente revisará tu entrega pronto. Te notificaremos cuando tengas tu calificación.
                      </p>
                      <div className="flex items-center gap-2 text-xs sm:text-sm text-purple-605 dark:text-purple-400">
                        <CalendarIcon className="h-4 w-4" />
                        <span className="tabular-nums">Entregado el {formatDate(userSubmission.creado)}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {!isTeacher && !userSubmission && activity.esta_vencida && (
            <div className="bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-lg p-3 sm:p-4">
              <div className="flex items-start gap-2 text-red-700 dark:text-red-400">
                <ExclamationTriangleIcon className="h-5 w-5 text-red-600 dark:text-red-400 flex-shrink-0 mt-0.5" />
                <p className="text-red-700 dark:text-red-400 text-xs sm:text-sm font-medium">
      ...
      {isTeacher && (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-xl p-4 sm:p-5 lg:p-6">
          <h2 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">
            Entregas de Estudiantes <span className="tabular-nums">({submissions?.length || 0})</span>
          </h2>
      ...
      {showCancelConfirm && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="fixed inset-0 bg-black/40 backdrop-blur-sm" onClick={() => setShowCancelConfirm(false)} />
          
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative bg-white dark:bg-gray-900 rounded-xl w-full max-w-md shadow-xl border border-gray-200 dark:border-white/10 p-4 sm:p-6">
              <div className="text-center">
                <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-red-50 dark:bg-red-500/10 mb-4">
                  <ExclamationTriangleIcon className="h-6 w-6 text-red-655 dark:text-red-400" />
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition text-sm sm:text-base active:scale-[0.96]"
                  >
                    No, mantener
                  </button>
                  <button
                    ...
                    className="flex-1 bg-red-600 text-white px-4 py-2.5 rounded-lg hover:bg-red-700 transition disabled:opacity-50 text-sm sm:text-base flex items-center justify-center gap-2 active:scale-[0.96]"
                  >
