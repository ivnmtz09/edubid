        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-3 sm:p-4 shadow-sm border border-gray-200 dark:border-gray-800">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">Actividades</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
        ...
        >
          <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white text-base sm:text-lg">Nueva Clase</h3>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">Crea una nueva clase</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white text-base sm:text-lg">Nuevo Grupo</h3>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">Organiza a tus estudiantes</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white text-base sm:text-lg">Nueva Actividad</h3>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">Asigna tareas y exámenes</p>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-gray-800">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Mis Clases</h2>
          ...
          {classrooms && classrooms.length > 0 ? (
                ...
                >
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <h4 className="font-medium text-gray-900 dark:text-white text-sm sm:text-base group-hover:text-yellow-700 dark:group-hover:text-yellow-400 truncate">{classroom.nombre}</h4>
            ...
            <div className="text-center py-6 sm:py-8">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm">No tienes clases creadas aún</p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-gray-800">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Actividades Recientes</h2>
          ...
          {activities && activities.length > 0 ? (
              ...
              {activities.slice(0, 5).map((activity) => (
                ...
                >
                  <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <h4 className="font-medium text-gray-900 dark:text-white text-sm sm:text-base group-hover:text-purple-700 dark:group-hover:text-purple-400 truncate">{activity.nombre}</h4>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
            ...
            <div className="text-center py-6 sm:py-8">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm">No has creado actividades aún</p>
            </div>
          )}
        </div>
      </div>
