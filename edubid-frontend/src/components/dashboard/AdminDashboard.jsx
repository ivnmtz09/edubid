...
export default function AdminDashboard() {
  ...
  const roleColors = {
    admin: "bg-red-100 text-red-700 border border-red-200 dark:bg-red-900/30 dark:text-red-400 dark:border-red-800/50",
    docente: "bg-blue-100 text-blue-700 border border-blue-200 dark:bg-blue-900/30 dark:text-blue-400 dark:border-blue-800/50",
    estudiante: "bg-green-100 text-green-700 border border-green-200 dark:bg-green-900/30 dark:text-green-400 dark:border-green-800/50"
  }
  ...
  return (
    <div className="space-y-6 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      {/* Header */}
      <div className="relative overflow-hidden rounded-2xl p-8 sm:p-12 mb-8 shadow-lg transition-colors duration-300 bg-gray-800">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-3 sm:p-4 shadow-sm border border-gray-200 dark:border-gray-800">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">Docentes</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-gray-800">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4 sm:mb-6">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-3 lg:mb-0">Gestión de Usuarios</h2>
        ...
        <div className="space-y-2 sm:space-y-3">
          {filteredUsers?.map((u) => (
            <div key={u.id} className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-100 dark:border-gray-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:border-blue-200 dark:hover:border-blue-800/50 transition-all duration-200">
              <div className="flex items-center space-x-3 sm:space-x-4 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center space-x-2 mt-1">
                    ...
                    <span className="text-xs text-gray-500 dark:text-gray-500 hidden sm:inline">ID: {u.id}</span>
                  </div>
                </div>
              </div>
        ...
        {filteredUsers?.length === 0 && (
          <div className="text-center py-8 sm:py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm">No se encontraron usuarios</p>
          </div>
        )}
      </div>
    </div>
