  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-full items-center justify-center p-4">
        {/* FIX: era solo bg-opacity-40 sin color — el backdrop era invisible */}
        <div
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <button
              onClick={onClose}
              // FIX: dark:bg-gray-900 era un valor fijo que no corresponde al contexto del modal
          ...
          >
            ...
            <div>
              ...
              {classroomsLoading ? (
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-3 sm:px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors text-sm sm:text-base"
                  required
                >
              ...
              {classrooms?.length === 0 && (
                <p className="text-xs text-orange-600 dark:text-orange-400 mt-1">
                  No tienes clases creadas. Primero crea una clase para poder
                  asociar el grupo.
                </p>
              )}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-4">
              <button
                type="button"
                onClick={onClose}
                // FIX: hover:bg-gray-50 sin dark variant, dark:bg-gray-900 incorrecto
